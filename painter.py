    ...
    def paintEvent(self, event):
        ...
        for figure in self.__figures:
            ...
            if isinstance(figure, Ellipse):
                ...
                painter.drawEllipse(figure.x, figure.y,
                                    figure.width, figure.height)
                continue
...
if __name__ == '__main__':
    ...
    figures = [Rectangle(20, 30, 400, 200),
               Rectangle(100, 300, 300, 50),
               Ellipse(30, 400, 300, 80),
               Ellipse(350, 400, 200, 50),
               CloseFigure(35, 400, 300, 80),
               CloseFigure(20, 30, 400, 100)]
    # figures = []
